...
def viewing_data():
    ...
    for key in data_set.keys():
        print(key)
    ans=input("Please input the ID to see the person:\n")
    f.close()
...
if __name__ == '__main__':
    ...
    Button(Bu,text='识别人脸',anchor='c',bg='blue',command=PrintButton1, width=15, ).pack()
    Button(Bu, text='增加人脸数据', anchor='c', bg='blue', command=PrintButton2, width=15).pack()
    Button(Bu, text='删除人脸数据', anchor='c', bg='blue', command=PrintButton3, width=15).pack()
    Button(Bu, text='查看已有人脸数据', anchor='c', bg='blue', command=PrintButton4, width=15).pack()
